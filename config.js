...
(() => {
  ...
  if (!window.BEAUTIX_DISABLE_CASHFLOW_PAYMENT_EDITOR) load('script[data-beautix-cashflow-payment-editor-v3]', 'cashflow-payment-editor-v3.js?v=20260802-auth-storage1', 'beautixCashflowPaymentEditorV3');
